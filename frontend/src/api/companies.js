...
export const updateSubscriptionApi = (id, payload) =>
  axiosClient.put(`/companies/${id}/subscription`, payload).then((r) => r.data);
export const getExpiringCompaniesApi = (days) =>
  axiosClient.get('/companies/expiring', { params: days ? { days } : undefined }).then((r) => r.data);
